...
const contentTitles = {
  ...
  gallery: [
    ...
    'Seed: Food distribution program',
    'Seed: Youth volunteer team',
  ],
  meetings: [
  ...
  notices: [
    ...
    'Seed: Friday clean-up campaign',
    'Seed: Scholarship application deadline',
    'Seed: Emergency medical support desk',
    'Seed: Public donation report published',
  ...
  await OrganizationSetting.findOneAndUpdate(
    { key: 'default' },
    {
      ...
      homepageControls: {
        ...
        facebookEmbedEnabled: true,
        facebookPageUrl: 'https://www.facebook.com/',
        fontSizeControlsEnabled: true,
        galleryDownloadEnabled: true,
        googleMapsEmbedUrl: 'https://www.google.com/maps?q=Dargah%20Para%2C%20Bangladesh&output=embed',
...
const seedContent = async (admin, members) => {
  await Notice.create([
    ...
    {
      audience: AUDIENCES.PUBLIC,
      body: 'Youth volunteers will clean the mosque road, notice board area, and school lane this Friday morning.',
      category: 'অনুষ্ঠান',
      createdBy: admin._id,
      imageUrl: image('notice-cleanup'),
      pinned: false,
      title: contentTitles.notices[1],
    },
    {
      audience: AUDIENCES.PUBLIC,
      body: 'Students can submit scholarship support requests with guardian phone number and school information.',
      category: 'শিক্ষা',
      createdBy: admin._id,
      imageUrl: image('notice-scholarship'),
      pinned: false,
      title: contentTitles.notices[2],
    },
    {
      audience: AUDIENCES.PUBLIC,
      body: 'A temporary medical support desk will collect emergency medicine requests and donor commitments.',
      category: 'জরুরি',
      createdBy: admin._id,
      imageUrl: image('notice-medical'),
      pinned: false,
      title: contentTitles.notices[3],
    },
    {
      audience: AUDIENCES.PUBLIC,
      body: 'This month donation collection summary has been published for public transparency review.',
      category: 'আর্থিক',
      createdBy: admin._id,
      imageUrl: image('notice-finance'),
      pinned: false,
      title: contentTitles.notices[4],
    },
    {
      ...
      category: 'আর্থিক',
      createdBy: admin._id,
      imageUrl: image('notice-member-finance'),
      pinned: false,
      title: contentTitles.notices[5],
    },
  ])
  ...
  await GalleryItem.create([
    ...
    },
    {
      audience: AUDIENCES.PUBLIC,
      createdBy: members[3]._id,
      description: 'Public donation handover record for the transparency gallery.',
    ...
    },
    {
      ...
      description: 'Food packets arranged for families before distribution.',
      imageUrl: image('gallery-food'),
      title: contentTitles.gallery[4],
    },
    {
      audience: AUDIENCES.PUBLIC,
      createdBy: members[5]._id,
      description: 'Youth volunteers preparing for the next community program.',
      imageUrl: image('gallery-youth'),
      title: contentTitles.gallery[5],
    },
  ])
}
...
const seedHomepageContent = async () => {
  await CommitteeMember.create([
    ...
    {
      active: true,
      name: 'Seed: Nusrat Jahan',
      order: 5,
      phone: '01750000005',
      photo: avatar('Nusrat Jahan'),
      position: 'Education & service coordinator',
      showPhone: false,
    },
  ])
